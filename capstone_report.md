...
This project takes a similar approach to attempt to predict bird species from digital audio recordings of their vocalizations. Using recordings from [Xeno Canto](https://www.xeno-canto.org/), a crowd-sourced Creative Commons database of audio recordings from around the world, the [Xeno-Canto Avian Vocalizations CA/NV, USA](https://www.kaggle.com/samhiatt/xenocanto-avian-vocalizations-canv-usa) small subset was curated to jumpstart exploration into this space. This dataset includes 30 varying length audio samples for each of 91 different avian species common in California and Nevada, USA.
